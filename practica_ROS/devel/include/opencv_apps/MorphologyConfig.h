...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(MorphologyConfig::AbstractParamDescriptionConstPtr(new MorphologyConfig::ParamDescription<int>("morph_operator", "int", 0, "Morphology Operation Methods", "{'enum': [{'name': 'Opening', 'type': 'int', 'value': 0, 'srcline': 10, 'srcfile': '/home/vboxuser/practica_ws/src/opencv_apps/cfg/Morphology.cfg', 'description': 'Opening', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Closing', 'type': 'int', 'value': 1, 'srcline': 11, 'srcfile': '/home/vboxuser/practica_ws/src/opencv_apps/cfg/Morphology.cfg', 'description': 'Closing', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Gradient', 'type': 'int', 'value': 2, 'srcline': 12, 'srcfile': '/home/vboxuser/practica_ws/src/opencv_apps/cfg/Morphology.cfg', 'description': 'Gradient', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Top_Hat', 'type': 'int', 'value': 3, 'srcline': 13, 'srcfile': '/home/vboxuser/practica_ws/src/opencv_apps/cfg/Morphology.cfg', 'description': 'Top Hat', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Black_Hat', 'type': 'int', 'value': 4, 'srcline': 14, 'srcfile': '/home/vboxuser/practica_ws/src/opencv_apps/cfg/Morphology.cfg', 'description': 'Black Hat', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'An enum for Morphology Operations'}", &MorphologyConfig::morph_operator)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(MorphologyConfig::AbstractParamDescriptionConstPtr(new MorphologyConfig::ParamDescription<int>("morph_operator", "int", 0, "Morphology Operation Methods", "{'enum': [{'name': 'Opening', 'type': 'int', 'value': 0, 'srcline': 10, 'srcfile': '/home/vboxuser/practica_ws/src/opencv_apps/cfg/Morphology.cfg', 'description': 'Opening', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Closing', 'type': 'int', 'value': 1, 'srcline': 11, 'srcfile': '/home/vboxuser/practica_ws/src/opencv_apps/cfg/Morphology.cfg', 'description': 'Closing', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Gradient', 'type': 'int', 'value': 2, 'srcline': 12, 'srcfile': '/home/vboxuser/practica_ws/src/opencv_apps/cfg/Morphology.cfg', 'description': 'Gradient', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Top_Hat', 'type': 'int', 'value': 3, 'srcline': 13, 'srcfile': '/home/vboxuser/practica_ws/src/opencv_apps/cfg/Morphology.cfg', 'description': 'Top Hat', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Black_Hat', 'type': 'int', 'value': 4, 'srcline': 14, 'srcfile': '/home/vboxuser/practica_ws/src/opencv_apps/cfg/Morphology.cfg', 'description': 'Black Hat', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'An enum for Morphology Operations'}", &MorphologyConfig::morph_operator)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 10 "/home/vboxuser/practica_ws/src/opencv_apps/cfg/Morphology.cfg"
      const int Morphology_Opening = 0;
//#line 11 "/home/vboxuser/practica_ws/src/opencv_apps/cfg/Morphology.cfg"
      const int Morphology_Closing = 1;
//#line 12 "/home/vboxuser/practica_ws/src/opencv_apps/cfg/Morphology.cfg"
      const int Morphology_Gradient = 2;
//#line 13 "/home/vboxuser/practica_ws/src/opencv_apps/cfg/Morphology.cfg"
      const int Morphology_Top_Hat = 3;
//#line 14 "/home/vboxuser/practica_ws/src/opencv_apps/cfg/Morphology.cfg"
