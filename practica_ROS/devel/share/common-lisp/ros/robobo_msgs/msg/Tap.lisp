...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Tap>)))
  ...
  (cl:format cl:nil "# Represents the coordinate of a tap gesture~%# on the device's screen~%#~%# X coordinate~%std_msgs/Int8 x~%# Y coordinate~%std_msgs/Int8 y~%~%================================================================================~%MSG: std_msgs/Int8~%int8 data~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Tap)))
  "Returns full string definition for message of type 'Tap"
  (cl:format cl:nil "# Represents the coordinate of a tap gesture~%# on the device's screen~%#~%# X coordinate~%std_msgs/Int8 x~%# Y coordinate~%std_msgs/Int8 y~%~%================================================================================~%MSG: std_msgs/Int8~%int8 data~%~%~%"))
