...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Fling>)))
  ...
  (cl:format cl:nil "# Message used to represent a gross gesture on the screen~%#~%# Angle in radiants of the fling gesture~%std_msgs/Int16 angle~%# Time in milliseconds between the start and the end~%# of the gesture~%std_msgs/Int32 time~%# Distance between the beginning coordinate and ~%# the ending coordinate~%std_msgs/Int16 distance~%~%================================================================================~%MSG: std_msgs/Int16~%int16 data~%~%================================================================================~%MSG: std_msgs/Int32~%int32 data~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Fling)))
  "Returns full string definition for message of type 'Fling"
  (cl:format cl:nil "# Message used to represent a gross gesture on the screen~%#~%# Angle in radiants of the fling gesture~%std_msgs/Int16 angle~%# Time in milliseconds between the start and the end~%# of the gesture~%std_msgs/Int32 time~%# Distance between the beginning coordinate and ~%# the ending coordinate~%std_msgs/Int16 distance~%~%================================================================================~%MSG: std_msgs/Int16~%int16 data~%~%================================================================================~%MSG: std_msgs/Int32~%int32 data~%~%"))
