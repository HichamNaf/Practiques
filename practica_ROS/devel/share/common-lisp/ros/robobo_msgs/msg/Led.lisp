...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Led>)))
  ...
  (cl:format cl:nil "# Represents a change of color in a led~%#~%# String that identifies the led~%# Possible values: Front-C, Front-R, Front-L,~%# Front-RR, Front-LL, Back-C, Back-R, Back-L.~%std_msgs/String id~%# New color of the led in the RGBA space~%std_msgs/ColorRGBA color~%~%================================================================================~%MSG: std_msgs/String~%string data~%~%================================================================================~%MSG: std_msgs/ColorRGBA~%float32 r~%float32 g~%float32 b~%float32 a~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Led)))
  "Returns full string definition for message of type 'Led"
  (cl:format cl:nil "# Represents a change of color in a led~%#~%# String that identifies the led~%# Possible values: Front-C, Front-R, Front-L,~%# Front-RR, Front-LL, Back-C, Back-R, Back-L.~%std_msgs/String id~%# New color of the led in the RGBA space~%std_msgs/ColorRGBA color~%~%================================================================================~%MSG: std_msgs/String~%string data~%~%================================================================================~%MSG: std_msgs/ColorRGBA~%float32 r~%float32 g~%float32 b~%float32 a~%~%~%"))
