...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Wheels>)))
  ...
  (cl:format cl:nil "# Represents a change on the Rob base wheels~%#~%# Position (encoder) of the right wheel~%std_msgs/Int64 wheelPosR~%# Position (encoder) of the left wheel~%std_msgs/Int64 wheelPosL~%# Current right wheel speed~%std_msgs/Int64 wheelSpeedR~%# Current left wheel speed~%std_msgs/Int64 wheelSpeedL~%~%================================================================================~%MSG: std_msgs/Int64~%int64 data~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Wheels)))
  "Returns full string definition for message of type 'Wheels"
  (cl:format cl:nil "# Represents a change on the Rob base wheels~%#~%# Position (encoder) of the right wheel~%std_msgs/Int64 wheelPosR~%# Position (encoder) of the left wheel~%std_msgs/Int64 wheelPosL~%# Current right wheel speed~%std_msgs/Int64 wheelSpeedR~%# Current left wheel speed~%std_msgs/Int64 wheelSpeedL~%~%================================================================================~%MSG: std_msgs/Int64~%int64 data~%~%"))
