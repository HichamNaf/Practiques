...
"""autogenerated by genpy from robobo_msgs/SetLedCommand.msg. Do not edit."""
import codecs
import sys
...
class SetLedCommand(genpy.Message):
  _md5sum = "67de51c92b3fb96ec94dabeed286e658"
  _type = "robobo_msgs/SetLedCommand"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# Commands the robot to change a led to a predifined color
#
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SetLedCommand, self).__init__(*args, **kwds)
