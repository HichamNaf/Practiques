...
char ConfWIFI(void){
  ...
  case 6:
        ...
        case 10:
            ...
            return 0;
        case 11:
            if (MotorCOM("AT+CIPSTART=\"UDP\",\"255.255.255.255\",\0")==3){
...
char ListLastMessages (void) {
    ...
    case 0:
     ...
     case 4:
         ...
         break;
     case 5:
         if (finishConversion()==1 && mouJoyAvail()==1) {
             action=getAction();
             state_option++;
         }
         else if (finishConversion()==1 && mouJoyAvail()==0) {
             state_option=3;
         }
         return 0;
     case 6:
