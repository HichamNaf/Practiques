...
public final class ApiHelper {
     ...
     *
     * @throws ApiConection If your computer doesn't support SSL at all. If you get this exception when calling the
     *                     constructor, contact the OOPD teachers.
     */
    public ApiHelper() throws ApiConection {
        ...
        try {
            ...
            getFromUrl("https://balandrau.salle.url.edu/dpoo/S1-Project_6/characters");
        } catch (NoSuchAlgorithmException | KeyManagementException | IOException e) {
            // Exceptions are simplified for any classes that need to catch them
            throw new ApiConection("Can't Connect Appi",e);
        }
    }
